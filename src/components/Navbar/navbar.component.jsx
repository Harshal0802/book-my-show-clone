...
const NavbarLg = () => {
    return (
        <div className="container mx-auto px-10 flex items-center justify-between">
            <div className="flex items-center w-full w-1/2 gap-3">
            ...
            <div className="flex items-center gap-3">
                <span className="text-gray-200 text-xs flex items-center hover:text-white hover:cursor-pointer">Mumbai<BiChevronDown /></span>
